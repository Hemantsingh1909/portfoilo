  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 text-center lg:text-left order-2 lg:order-1">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <p className="text-lg text-muted-foreground/80 max-w-md">
                  Specializing in full-stack development, AI/ML practices, and scalable solutions 
            ...
            <div className="flex gap-4 justify-center lg:justify-start">
              <Button 
                ...
                onClick={() => window.open("https://github.com/Hemantsingh1909", "_blank")}
              >
              ...
              <Button 
                ...
                size="icon" 
                className="h-12 w-12 rounded-full bg-background/50 backdrop-blur-sm border border-primary/10 hover:bg-primary/10 hover:border-primary/30 transition-all duration-300"
                onClick={() => window.open("https://www.linkedin.com/in/hemantsatwal/", "_blank")}
              >
              ...
              <Button 
                ...
                size="icon" 
                className="h-12 w-12 rounded-full bg-background/50 backdrop-blur-sm border border-primary/10 hover:bg-primary/10 hover:border-primary/30 transition-all duration-300"
                onClick={() => window.open("mailto:hemantsingh1909@gmail.com")}
              >
            ...
            <div className="relative">
              ...
              <div className="relative z-10 group">
                <div className="relative w-80 h-80 lg:w-96 lg:h-96 rounded-full overflow-hidden bg-gradient-to-br from-primary/10 to-secondary/10 backdrop-blur-sm border-4 border-background/50 shadow-2xl">
                  <ImageWithFallback
                    src={Profile}
                    alt="Hemant Satwal - Software Engineer"
        ...
        {/* Scroll Indicator */}
        <div
          className="absolute bottom-8 left-1/2 transform -translate-x-1/2 transition-opacity duration-150"
          style={{
